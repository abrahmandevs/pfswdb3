    ...
    <div class="container mx-auto py-20 text-white">
        ...
        <form method="get" class="grid grid-cols-12 gap-3 justify-center items-center">
            ...
            <div class="col-span-full text-center ">
                <button type="submit" name=" z-50 subContact" class="px-5 py-1 uppercase rounded-md text-white  bg-gradient-to-r from-blue-500 to-green-600 hover:bg-gradient-to-r hover:from-green-400 hover:to-blue-800 transition-all duration-700">Submit</button>
            </div>
        </form>
        <!-- Address Part -->
